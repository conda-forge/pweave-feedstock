About pweave-feedstock
======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pweave-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/mpastell/Pweave

Documentation: http://mpastell.com/pweave
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5394&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pweave-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pweave` can be installed with `conda`:
...
```
mamba install pweave
```

It is possible to list all of the versions of `pweave` available on your platform with `conda`:
...
```
mamba search pweave --channel conda-forge
```
...
mamba repoquery search pweave --channel conda-forge

# List packages depending on `pweave`:
mamba repoquery whoneeds pweave --channel conda-forge

# List dependencies of `pweave`:
mamba repoquery depends pweave --channel conda-forge
```
...
* [@mpastell](https://github.com/mpastell/)
